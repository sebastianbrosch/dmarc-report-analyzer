...
/// <summary>
/// A factory to create a feedback object of the DMARC report.
/// </summary>
public static class FeedbackFactory
{
    /// <summary>
    /// Creates a feedback object of the DMARC report.
    /// </summary>
    /// <param name="document">The DMARC report as a XML document.</param>
    /// <returns>A feedback object containing the information from the DMARC report.</returns>
